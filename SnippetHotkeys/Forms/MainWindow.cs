...
using static SnippetHotkeys.Program;
...
namespace SnippetHotkeys
{
    ...
    public partial class SnippetHotkeysMW : Form
    {
        ...
        public SnippetHotkeysMW()
        {
            ...
            Text = $"Snippet Hotkeys v{AppInfo.Version}";
        ...
        // Issues button for hotkey registration feedback and issue reporting
        ...
        private void SnippetHotkeysMW_Load(object sender, EventArgs e)
        {
